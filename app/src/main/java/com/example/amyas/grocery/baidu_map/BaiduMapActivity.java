package com.example.amyas.grocery.baidu_map;
...
import com.example.amyas.grocery.util.ToastUtil;
...
//            mBaiduMap.setMapStatus(mapStatusUpdate);
    ...
    BaiduMap.OnMapClickListener mOnMapClickListener = new BaiduMap.OnMapClickListener() {
        ...
        public boolean onMapPoiClick(MapPoi mapPoi) {
            ToastUtil.showToast(BaiduMapActivity.this, mapPoi.getName());
            return false;
        }
    };
    ...
    BaiduMap.OnMarkerClickListener mOnMarkerClickListener = new BaiduMap.OnMarkerClickListener() {
        ...
        public boolean onMarkerClick(Marker marker) {
            ToastUtil.showToast(BaiduMapActivity.this, marker.getTitle());
            return false;
        }
    };
